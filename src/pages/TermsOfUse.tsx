  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg mb-8 text-sm text-slate-600 font-medium">
        <strong>Plain-language summary:</strong> Welcome to Rural Utility Cost. You are free to use these tools to help plan your operations. Do not scrape, clone, or abuse the sites. Everything is provided "as is" without warranty. If you make a bad business decision based on a calculator estimate, we are not responsible.
      </div>
      ...
      <div className="prose prose-slate max-w-none text-slate-600 text-sm space-y-6">
        <section>
          ...
          <p className="leading-relaxed">
            By accessing any tool within the Rural Utility Cost network (including all associated subdomains like Transport), you agree to be bound by these Terms of Use. The tools are explicitly provided for decision-support and estimations serving the agricultural and rural logistics community.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            The visual layout, unique calculator logic structures, domain names, and brand identifiers (such as the RUC logo marks) are the property of Rural Utility Cost. You may not duplicate, reverse-engineer, or distribute the application ecosystem without express written permission.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            To the maximum extent permitted by law, Rural Utility Cost is provided strictly "AS IS" and "AS AVAILABLE". We provide no warranties regarding accuracy, uptime, or merchantability. By using the site, you acknowledge that logistical variables require professional judgment and agree that Rural Utility Cost shall not be liable for any damages (direct, indirect, or consequential) arising from reliance on its output.
          </p>
        </section>
